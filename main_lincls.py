...
reset_default_value(parser, 'lr', 30.0)
reset_default_value(parser, 'weight_decay', 0.0)
reset_default_value(parser, 'epochs', 100)

parser.add_argument('--schedule', default=[60, 80], nargs='*', type=int,	
                help='learning rate schedule (when to drop lr by a ratio)')
parser.add_argument('--no_bias', action='store_true',
                help='Disable bias in the linear classifier')
        ...
        if os.path.isfile(args.pretrained):
            ...
            for k in list(state_dict.keys()):
                ...
                if k.startswith('module.encoder_q') and not k.startswith('module.encoder_q.fc'):
                    ...
                    if k in ['module.fc.weight', 'module.fc.bias']:
                        continue
...
def sanity_check(state_dict, pretrained_weights):
    ...
    is_moco = 'encoder_q' in list(state_dict_pre.keys())[5]
